...
origin_loot_tables_path = os.path.join(os.path.dirname(__file__),"default_loot_tables")
# ランダム化したルートテーブルを入れる場所を指定
target_loot_table_path = os.path.join(os.path.dirname(__file__),"data","minecraft","loot_tables")
